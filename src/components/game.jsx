  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h1 data-aos="fade-in" className="mb-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">{preguntaActual.label}</h1>
        <ul className="grid w-full gap-6 md:grid-cols-1">
            {preguntaActual.respuestas.map((respuesta , index) => (
                  <li data-aos="zoom-in-down" key={respuesta._id}>
                    <input
                        type="radio"
